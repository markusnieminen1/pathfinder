...
func BreadthFirstSearchStations(root, target *data.Station, path *[]string) {
	...
	for queue.Len() > 0 {
		...
		data.Events = append(data.Events, data.SearchEvent{Station_Id: currentNode.ID, Visited: true})
